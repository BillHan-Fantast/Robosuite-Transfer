...
class CustomRobotReplayBuffer(ReplayBuffer):
    def __init__(
        self,
        env,
        ...
        self._robot_state_dim = get_dim(self.observation_space['robot_states'])
        self._object_state_dim = get_dim(self.observation_space['object_states'])
